...
const analyzeGrievanceFallback = (description) => {
  ...
  if (text.includes('attendance') || text.includes('bunk') || text.includes('presence')) {
    ...
    category = 'Faculty Related Issues';
    suggestedDepartment = 'Academic Affairs';
  }
...
- category (one of: Attendance Issues, Examination Issues, Marks / Re-evaluation, Fee Related Issues, Scholarship Issues, Hostel Complaints, Library Complaints, Infrastructure Problems, Faculty Related Issues, Technical / Lab Issues, Other)
